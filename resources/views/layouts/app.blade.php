          ...
          <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
              <div class="navbar-brand-wrapper d-flex justify-content-center sucess">
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                  <a class="navbar-brand brand-logo" href="#"><img src="{{ asset('public/images/parity.png') }}" alt="logo"/></a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                          ...
                          <a class="dropdown-item preview-item" href="{{ route('logout') }}">
                            <div class="preview-thumbnail">
                                ...
                                <img src="{{ asset('public/logout_icon.png') }}" alt="image" class="profile-pic">
                            </div>
            ...
            @if(session('title') == 'Admin')
             ...
             <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{ route('user.list') }}">{{ __('User List') }}</a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{ route('create-user') }}">{{ __('Create User') }} <div class="badge badge-success">{{ __('new') }}</div></a></li>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#product-batch_boq-elements" aria-expanded="false" aria-controls="product-batch_boq-elements">
                    ...
                    <div class="collapse" id="product-batch_boq-elements">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">  <a class="nav-link" href="{{ route('batch_list') }}">Order List</a></li>
                        </ul>
                    </div>
                  </li>

                  <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#product-batch-elements" aria-expanded="false" aria-controls="product-batch-elements">
                        <i class="menu-icon mdi mdi-format-list-numbers"></i>
                    ...
                    <div class="collapse" id="product-batch-elements">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">  <a class="nav-link" href="{{ route('boq.list') }}">BOQ List</a></li>
                        </ul>
                    </div>
                  </li>
                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse" id="product-elements">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">  <a class="nav-link" href="{{ route('site.list') }}">{{ $childSidebar['sl'] }}</a></li>
                        </ul>
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">  <a class="nav-link" href="{{ route('site.add') }}">{{ $childSidebar['sa'] }}</a></li>
                        </ul>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#vsitemapping-elements" aria-expanded="false" aria-controls="vsitemapping-elements">
                        <i class="typcn typcn-film menu-icon"></i>
                    ...
                    <div class="collapse" id="vsitemapping-elements">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">  <a class="nav-link" href="{{ route('vendor-site-mapping') }}">{{ __('Vendor Site Allocation') }}</a></li>
                        </ul>

                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">  <a class="nav-link" href="{{ route('vendor.site') }}">{{ __('List of Allocated Site') }}</a></li>
                        </ul>
                    </div>
                  </li>
                  ...
                  <div class="card">
                      <div class="card-body">
                          <div class="d-sm-flex justify-content-center justify-content-sm-between">
                              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2023 <a href="#" class="text-muted" target="_blank"></a>. Parity InfoTech Solutions. All rights reserved.</span>
                              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center text-muted"> <a href="#" class="text-muted" target="_blank"></a>paritysystem.in</span>
                          </div>
                      </div>
                  </div>
                </footer>
        ...
        <script>
          ...
          if(current_url == 'http://localhost/laravel/parity-product/public/item_list'){
            $('body').on('click','#show-value',function(e){
                e.preventDefault();
                console.log("ask.. send message vendor & store Manager/Officer with PDF formate or Link own website this pdf..")
