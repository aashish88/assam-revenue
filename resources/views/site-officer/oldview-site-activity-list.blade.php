                            ...
                            <tbody class="tbody">
                                @foreach ($siteData as $res)
                                    ...
                                    <tr>
                                        ...
                                        <td class="ask_td">{{ $res->user_name }}</td>
                                        ...
                                        <td>
                                            <img src="{{ url($res->document_filepath) }}" alt="">
                                        </td>
                                        <td>
                                            <a href="{{ url($res->sitepic_filepath) }}"><img src="{{ url($res->sitepic_filepath) }}" alt=""></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
