            ...
            <div class="card-body">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="modal-footer modifyDatabatchIdGet">
                        <p id="getInputll" name="batch_id" class="btn btn-info btn-rounded mr-2" style="">Submit</p>
                    </div>
                </div>
                ...
                <table class="table table-striped table-class" id="table-id">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-email="{{ $user[$key]->email }}"><input type="checkbox"></td>    </tr>
                            @endif
                        @endforeach
