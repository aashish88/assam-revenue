                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select class="form-control" value="{{ old('staff_type') }}" name="staff_type">
                                            ...
                                            <option value="1" <?php if (old('staff_type') == 1) {
                                                echo 'selected';
                                            } ?>>Admin</option>
                                            <option value="3" <?php if (old('staff_type') == 3) {
                                                echo 'selected';
                                            } ?>>Vendor</option>
                                            <option value="2" <?php if (old('staff_type') == 2) {
                                                echo 'selected';
                                            } ?>>Officer</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="role_type">
                                            ...
                                            <option value="2" <?php if (old('role_type') == 2) {
                                                echo 'selected';
                                            } ?>>View</option>
                                            <option value="3" <?php if (old('role_type') == 3) {
                                                echo 'selected';
                                            } ?>>Update</option>
                                            <option value="1" <?php if (old('role_type') == 1) {
                                                echo 'selected';
                                            } ?>>Admin</option>
                                        </select>
                                        @error('role_type')
                        ...
                        <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" class="form-control" name="user_email"
                                            value="{{ old('user_email') }}" id="exampleInputEmail1"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="user_no"
                                            value="{{ old('user_no') }}" id="exampleInputEmail1"
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="assword" class="form-control" name="pwd"
                                            value="{{ old('pwd') }}" id="password"
